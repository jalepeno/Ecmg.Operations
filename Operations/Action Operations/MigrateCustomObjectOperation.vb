'  ---------------------------------------------------------------------------------
'  ---------------------------------------------------------------------------------
'   Document    :  MigrateCustomObjectOperation.vb
'   Description :  [type_description_here]
'   Created     :  9/2/2015 2:37:08 PM
...
Public Class MigrateCustomObjectOperation
  Inherits ActionOperation

#Region "Class Constants"

  Private Const OPERATION_NAME As String = "MigrateCustomObject"
