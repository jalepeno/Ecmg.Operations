'  ---------------------------------------------------------------------------------
'  ---------------------------------------------------------------------------------
'   Document    :  TransformFolderOperation.vb
'   Description :  [type_description_here]
'   Created     :  6/9/2015 12:22:34 PM
...
Public Class TransformFolderOperation
  Inherits ActionOperation

#Region "Class Constants"

  Public Const OPERATION_NAME As String = "TransformFolder"
...
#Region "Private Methods"
  ...
  Private Function TransformFolder() As Result
    Try

      RunPreOperationChecksForFolder(True)
      ...
      If Transformations Is Nothing OrElse Transformations.Count = 0 Then
        ...
        End If
      End If
      Dim lobjFolder As Folder = Nothing
      ...
      If (lobjTransform Is Nothing) Then
        Me.ProcessedMessage = "Unable to transform folder, the primary transformation is not initialized."
      ...
      Else
        ...
        lobjFolder = lobjItemTransform.TransformFolder(Me.WorkItem.Folder, lstrErrorMessage)
        ...
        If (lobjFolder Is Nothing) Then
          Me.ProcessedMessage = String.Format("{0} - Failed to transform folder. Batch item id '{1}' Batch Id '{2}' Error: '{3}'",
                                            Reflection.MethodBase.GetCurrentMethod, Me.DocumentId, Me.Parent.Id, lstrErrorMessage)
          menuResult = OperationEnumerations.Result.Failed
          OnError(New OperableErrorEventArgs(Me, WorkItem, Me.ProcessedMessage))
          Return menuResult
        End If
        Me.WorkItem.Folder = lobjFolder
